            ...
            <div className="sticky top-0 h-screen flex items-center">
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-[#1F2937] mb-6">
                  Your health change <span className="text-[#20c858]">partner</span>
                </h2>
                  ...
                  {[
                    {
                      ...
                      description: "Daily tasks across exercise, nutrition, sleep and mental wellness — built on your results.",
                      icon: (
