    ...
    <div>
              ...
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <Link
                      href="/assessment"
                      className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-semibold text-white bg-[#10B981] rounded-full hover:bg-[#047857] transition-all duration-200 shadow-md shadow-green-500/25"
                    >
                      View Packages
                    </Link>
                  </div>
      ...
      <div className="bg-white lg:hidden pb-20">
        <div className="max-w-md mx-auto px-4">
          <StaticPhone screenshot="/app-screenshot-home-static.jpg" alt="Lifeline Health app" phoneHeight="62vh" />
        </div>
      </div>
