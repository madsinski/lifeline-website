...
export default function Footer() {
  ...
  if (pathname.startsWith("/survey") || pathname.startsWith("/research") || pathname.startsWith("/verkefnalysing") || pathname.startsWith("/present") || pathname.startsWith("/security-review") || pathname.startsWith("/leidbeiningar") || pathname.startsWith("/legal-review")) {
    return null;
  }
