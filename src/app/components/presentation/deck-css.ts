...
.lldeck .grp-head .grp-logo{height:clamp(30px,3.2cqw,48px);width:auto;max-width:100%;object-fit:contain;object-position:left center;display:block;}
.lldeck .dark .grp-head .grp-logo{filter:brightness(0) invert(1);}
