      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-2.5 rounded-full shadow-lg transition-all duration-200 ${
          open
            ...
            : "bg-[#20c858] text-white hover:bg-[#1ab34d] hover:shadow-xl"
        }`}
      >
        {open ? (
          ...
          {submitted ? (
            ...
            <div className="p-5">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm text-[#1F2937] placeholder-gray-400 focus:ring-2 focus:ring-[#20c858] outline-none resize-none"
                autoFocus
              />
              ...
              <button
                ...
                className="w-full py-2.5 bg-[#20c858] text-white text-sm font-semibold rounded-xl hover:bg-[#1ab34d] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
