...
// Editable content for the homepage "What's new" carousel.
// Backed by supabase/migration-whats-new.sql (single row, id = 1).

// GET — return the stored content blob (any active staff). Empty `{}` when unset;
// the client merges it over DEFAULT_WHATS_NEW.
