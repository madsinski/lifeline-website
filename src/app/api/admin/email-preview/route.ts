...
export async function GET(req: NextRequest) {
  ...
  const sampleData = {
    ...
    bookUrl: `${BASE}/account`,
    portalUrl: `${BASE}/account`,
    dayLabels: ["Mon, 19 May — Sameind Laugavegur", "Wed, 21 May — Sameind Laugavegur", "Fri, 23 May — Sameind Smáralind"],
    approvedDays: [
    ...
    dashboardUrl: `${BASE}/business/sample-company`,
    slotTime: "09:30",
    eventCount: 2,
    bloodDayCount: 3,
    adminUrl: `${BASE}/admin/business`,
    quantity: 24,
    unitPrice: 49900,
    amountTotal: 1197600,
