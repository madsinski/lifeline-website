    ...
    <div>
      ...
      <div className="bg-white lg:hidden pb-16">
        <div className="max-w-md mx-auto px-4">
          <StaticPhone screenshot="/app-screenshot-health-static.jpg" alt="Your health results in the app" phoneHeight="62vh" />
        </div>
      </div>
      ...
      <div className="bg-[#ecf0f3] lg:hidden pb-16">
        <div className="max-w-md mx-auto px-4">
          <StaticPhone screenshot="/app-screenshot-blood-static.jpg" alt="Track measurements and blood tests" phoneHeight="62vh" />
        </div>
      </div>
