    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-16 items-center">
            ...
            <div className="flex justify-center">
              <StaticPhone screenshot="/app-screenshot-health-static.png" alt="Your health results in the app" phoneHeight="60vh" />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="bg-white lg:hidden pb-16">
        <div className="max-w-md mx-auto px-4">
          <StaticPhone screenshot="/app-screenshot-health-static.png" alt="Your health results in the app" phoneHeight="52vh" />
        </div>
      </div>
      ...
      <section className="bg-[#ecf0f3] hidden lg:block py-24 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-16 items-center">
            <div className="flex justify-center">
              <StaticPhone screenshot="/app-screenshot-blood-static.png" alt="Track measurements and blood tests" phoneHeight="60vh" />
            </div>
            <div>
              <div>
      ...
      <div className="bg-[#ecf0f3] lg:hidden pb-16">
        <div className="max-w-md mx-auto px-4">
          <StaticPhone screenshot="/app-screenshot-blood-static.png" alt="Track measurements and blood tests" phoneHeight="52vh" />
        </div>
      </div>
