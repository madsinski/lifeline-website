      ...
      <div className="max-w-md w-full text-center">
        {status === "verifying" && (
          <div className="bg-white rounded-2xl shadow-sm p-10">
            <div className="animate-spin w-10 h-10 border-4 border-[#20c858] border-t-transparent rounded-full mx-auto mb-5" />
        ...
        {status === "success" && (
          <div className="bg-white rounded-2xl shadow-sm p-10">
            <div className="w-16 h-16 bg-[#20c858] rounded-full flex items-center justify-center mx-auto mb-5">
              <svg
            ...
            <a
              ...
              className="inline-block bg-[#20c858] hover:bg-[#1ab34e] text-white font-semibold rounded-full px-8 py-3 transition-colors text-sm"
            >
