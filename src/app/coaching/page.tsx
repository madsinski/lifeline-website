...
const pillars = [
  ...
  },
  {
    ...
    color: "#767194",
    textColor: "text-[#767194]",
    bgColor: "bg-slate-50",
    borderColor: "border-[#767194]",
...
const typicalDay = [
  { time: "07:00", title: "Morning routine", description: "Vitamins, hydration, and movement", color: "#EA580C", category: "Exercise" },
  { time: "09:00", title: "Educational snippet", description: "A short health insight pops up", color: "#0EA5E9", category: "Mental" },
  { time: "12:00", title: "Lunch suggestion", description: "Meal idea with macro guidance", color: "#84CC16", category: "Nutrition" },
  { time: "15:00", title: "Breathing exercise", description: "Afternoon reset reminder", color: "#0EA5E9", category: "Mental" },
  { time: "18:00", title: "Workout plan", description: "Today's exercise session", color: "#EA580C", category: "Exercise" },
  { time: "21:00", title: "Sleep wind-down", description: "Evening routine for better rest", color: "#767194", category: "Sleep" },
];
    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex justify-center">
              <StaticPhone screenshot="/app-screenshot-coach-static.png" alt="Health coach in the app" phoneHeight="54vh" />
            </div>
          </div>
        </div>
      </section>
              ...
              <div key={row.feature} className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    { label: "Full", value: row.full, color: "text-[#10B981]" },
                  ].map((col) => (
                    <div key={col.label} className={`text-center py-2 rounded-lg ${col.label === "Full" ? "bg-[#10B981]/8" : "bg-gray-50"}`}>
      ...
      <section className="py-24 sm:py-28 bg-[#ecf0f3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/assessment"
            className="inline-flex items-center justify-center px-10 py-4 text-base font-semibold text-white bg-[#10B981] rounded-full hover:bg-[#047857] transition-all duration-200 shadow-lg shadow-green-500/25 hover:shadow-green-500/40"
          >
