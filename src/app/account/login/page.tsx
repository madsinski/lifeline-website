    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white via-[#f0f3f6] to-[#ecf0f3] px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#20c858] hover:bg-[#1ab34d] text-white font-semibold py-2.5 px-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading
                ? mode === "login"
                  ? "Signing in..."
          ...
          {mode === "login" && (
            <button
              ...
              className="block w-full text-center text-sm text-[#6B7280] hover:text-[#20c858] mt-4 transition-colors"
            >
        ...
        <p className="text-center text-[#6B7280] text-xs mt-6">
          <Link href="/" className="hover:text-[#20c858] transition-colors">
