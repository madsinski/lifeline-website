...
const EXERCISE_IMAGES: Record<string, string> = {
  ...
  "Dumbbell Chest Fly": `${IMG_BASE}Dumbbell_Fly/0.jpg`,
  ...
  "Front Raise": `${IMG_BASE}Front_Raise/0.jpg`,
  ...
  "Crunches": `${IMG_BASE}Crunch/0.jpg`,
        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/40 overflow-y-auto py-10">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 p-6 space-y-5">
            ...
            <div>
              ...
              <input type="url" value={editingExercise.illustration_url || ""} onChange={(e) => setEditingExercise({ ...editingExercise, illustration_url: e.target.value })} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#20c858] focus:border-transparent" placeholder="Image URL (https://...)" />
