...
const categoryDefs = [
  { key: "exercise", label: "Exercise", color: "#EA580C", icon: "barbell" },
  { key: "nutrition", label: "Nutrition", color: "#84CC16", icon: "nutrition" },
  { key: "sleep", label: "Sleep", color: "#767194", icon: "moon" },
  { key: "mental", label: "Mental", color: "#0EA5E9", icon: "happy" },
];
