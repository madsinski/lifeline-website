    ...
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Signed copies of the Lifeline Beta Tester Agreement. Each row is a tester
          who has accepted the NDA inside a beta build of the app. PDFs are stored
          in the private <code className="bg-gray-100 px-1 py-0.5 rounded">beta-nda-pdfs</code> bucket.
        </p>
      </div>
