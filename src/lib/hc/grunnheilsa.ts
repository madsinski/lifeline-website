...
const CATALOG: CatalogEntry[] = [
  ...
  { key: "svefn_vandamal", slug: "skor-svefn-vandamal", title: "Svefn — læknisfræðileg vandamál", kind: "score", pillar: "sleep", match: /svefn læknisfræðileg vandamál|svefn.*vandamál/, unit: "stig" },
  { key: "svefn_venjur", slug: "skor-svefn-venjur", title: "Svefn — venjur", kind: "score", pillar: "sleep", match: /svefn venjur/, unit: "stig" },
  { key: "hreyfing_vandamal", slug: "skor-hreyfing-vandamal", title: "Hreyfing — læknisfræðileg vandamál", kind: "score", pillar: "exercise", match: /hreyfing læknisfræðileg vandamál|hreyfing.*vandamál/, unit: "stig" },
  { key: "hreyfing_venjur", slug: "skor-hreyfing-venjur", title: "Hreyfing — venjur", kind: "score", pillar: "exercise", match: /hreyfing venjur/, unit: "stig" },
  { key: "naering_vandamal", slug: "skor-naering-vandamal", title: "Næring — læknisfræðileg vandamál", kind: "score", pillar: "nutrition", match: /næring læknisfræðileg vandamál|næring.*vandamál/, unit: "stig" },
  { key: "naering_venjur", slug: "skor-naering-venjur", title: "Næring — venjur", kind: "score", pillar: "nutrition", match: /næring venjur/, unit: "stig" },
  { key: "matarhegdun", slug: "skor-matarhegdun", title: "Matarhegðun", kind: "score", pillar: "nutrition", match: /matarhegðun/, unit: "stig" },
  { key: "koffin", title: "Koffín", kind: "score", pillar: "sleep", slug: "skor-koffin", match: /koffín/, unit: "stig" },
  { key: "nikotin", title: "Nikótín", slug: "skor-nikotin", kind: "score", match: /nikótín/, unit: "stig" },
  { key: "afengi", title: "Áfengi", slug: "skor-afengi", kind: "score", match: /áfengi/, unit: "stig" },
  { key: "onnur_efni", title: "Önnur efni", slug: "skor-onnur-efni", kind: "score", match: /önnur efni/, unit: "stig" },
  { key: "skjanotkun", title: "Skjánotkun", kind: "score", pillar: "mental", slug: "skor-skjanotkun", match: /skjánotkun/, unit: "stig" },
  { key: "fjarhaettuspil", title: "Fjárhættuspil", kind: "score", pillar: "mental", slug: "skor-fjarhaettuspil", match: /fjárhættuspil/, unit: "stig" },
  { key: "andleg_heilsa", slug: "skor-andleg-heilsa", title: "Andleg heilsa", kind: "score", pillar: "mental", match: /andleg heilsa/, unit: "stig" },
  { key: "streita", slug: "skor-streita", title: "Streita", kind: "score", pillar: "mental", match: /streita/, unit: "stig" },
  { key: "vellidan", slug: "skor-vellidan", title: "Almenn vellíðan", kind: "score", pillar: "mental", match: /almenn vellíðan|vellíðan/, unit: "stig" },

  { key: "thyngd", title: "Þyngd", slug: "thyngd", kind: "measure", match: /body weight|^þyngd/, unit: "kg" },
