...
export const DEFAULT_DOC: StationDoc = {
  ...
  blocks: [
    ...
    { type: "text", text: "Biddu skjólstæðing að fara úr öðrum skónum og sokknum og sitja á stól með hælinn upp á hlið." },
    { type: "text", text: "Kveiktu á tækinu með því að ýta einu sinni á ON-takkann." },
    { type: "image", src: IMG("a"), caption: "Mynd a — kveiktu á tækinu (ON-takkinn)" },
    { type: "text", text: "Bleyttu snertifletina fjóra." },
    { type: "image", src: IMG("b"), caption: "Mynd b — bleyta snertiflöt" },
    { type: "image", src: IMG("c"), caption: "Mynd c — bleyta snertiflöt" },
    { type: "image", src: IMG("d"), caption: "Mynd d — bleyta snertiflöt" },
    { type: "text", text: "Skjólstæðingur grípur um tækið með þumli og tveimur fingrum — mikilvægt er að snerta snertifletina." },
    { type: "image", src: IMG("e"), caption: "Mynd e — grip með þumli og tveimur fingrum" },
    { type: "image", src: IMG("f"), caption: "Mynd f — snerta snertifletina" },
    { type: "text", text: "Settu tækið niður á hælinn og haltu því þar til tækið segir að mælingin sé búin (eða þegar blátt ljós kviknar)." },
    { type: "image", src: IMG("g"), caption: "Mynd g — tækið sett á hælinn" },
    { type: "note", text: "Þegar bláa ljósið kviknar hefurðu 2 mínútur til að yfirfæra mælinguna í tölvuna." },
    { type: "text", text: "Smelltu á „Synchronise the measurement“." },
    { type: "image", src: IMG("5"), caption: "Synchronise the measurement" },
    { type: "text", text: "Smelltu svo á nafn tækisins og á „pair“." },
