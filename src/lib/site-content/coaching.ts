...
export const COACHING_DEFAULTS_IS: LocaleContent = {
  ...
  hero_subtitle:
    "Lifeline appið veitir persónulega daglega þjálfun þvert á fjórar stoðir heilsu. Byggt á niðurstöðum heilsumatsins þíns aðlagast þjálfunin eftir því sem þér fer fram.",

  why_title: "Af hverju heilsuþjálfun virkar",
  why_subtitle: "Þekking ein og sér skapar ekki breytingar. Þjálfun brúar bilið milli þess að vita og að gera.",
  why_c1_title: "Skapaðu raunverulegar breytingar",
  why_c1_desc: "Kerfi byggð á blóðprufunum þínum og líkamssamsetningu — ekki almenn sniðmát.",
  why_c2_title: "Daglegar aðgerðaáætlanir",
  why_c2_desc: "Vaknaðu við skýra áætlun á hverjum degi — hreyfingu, máltíðir, svefnvenjur og andlega líðan.",
  ...
  pillars_subtitle: "Heildræn nálgun að varanlegri vellíðan",
  pillars_features_label: "Eiginleikar",
  p1_title: "Hreyfing",
  p1_desc: "Persónuleg æfingakerfi hönnuð fyrir þitt getustig og markmið. Frá styrktarþjálfun til þols, liðleika og íþróttamiðaðrar þjálfunar. Kerfin aðlagast eftir því sem þér fer fram.",
  p1_features: ["Sérsniðin æfingakerfi", "Myndbönd með æfingum", "Eftirfylgni með stigvaxandi álagi", "Ráðleggingar um hvíldardaga", "Liðleika- og teygjuæfingar"].join("\n"),
  p2_title: "Næring",
  p2_desc: "Gagnreynd næringarráðgjöf sniðin að blóðprufuniðurstöðum þínum og líkamssamsetningu. Engir tískukúrar, aðeins sjálfbærar matarvenjur sem næra líkamann rétt.",
  p2_features: ["Persónulegar máltíðatillögur", "Ráðgjöf um stór- og snefilnæringarefni", "Eftirfylgni með vökvainntöku", "Ráðleggingar um bætiefni", "Bestun á tímasetningu máltíða"].join("\n"),
  p3_title: "Svefn",
  p3_desc: "Vísindalega studd bestun svefns til að bæta endurheimt, orku og einbeitingu. Fylgstu með svefngæðum þínum og fáðu persónulegar ráðleggingar.",
  p3_features: ["Bestun á svefntíma", "Kvöldrútína til að slaka á", "Ráð um svefnumhverfi", "Eftirfylgni með gæðum og þróun", "Samstilling líkamsklukku"].join("\n"),
  p4_title: "Andleg vellíðan",
  p4_desc: "Byggðu upp andlegt þrek með leiddri núvitund, öndunaræfingum og aðferðum við streitustjórnun. Tengstu styðjandi samfélagi fólks með sömu markmið.",
  p4_features: ["Leiddar núvitundaræfingar", "Öndunaræfingar", "Verkfæri fyrir streitustjórnun", "Eftirfylgni með líðan", "Stuðningur samfélags"].join("\n"),

  day_title: "Hvernig dæmigerður dagur lítur út",
  day_subtitle: "Appið leiðir þig í gegnum daginn með persónulegum áminningum",
  d1_title: "Morgunrútína", d1_desc: "Vítamín, vökvi og hreyfing",
  d2_title: "Fræðslumoli", d2_desc: "Stutt heilsuinnsýn birtist",
  d3_title: "Hádegistillaga", d3_desc: "Máltíðarhugmynd með næringarráðgjöf",
  d4_title: "Öndunaræfing", d4_desc: "Áminning um endurstillingu síðdegis",
  d5_title: "Æfingaáætlun", d5_desc: "Æfing dagsins",
  d6_title: "Kvöldró", d6_desc: "Kvöldrútína fyrir betri hvíld",

  how_title: "Hvernig þjálfun virkar",
  how_subtitle: "Heilsumatið þitt knýr þjálfunarupplifunina",
  h1_title: "Heilsumat fyrst", h1_desc: "Þjálfunin þín byrjar á heilsumati. Niðurstöðurnar móta allar ráðleggingar sem appið gefur.",
  h2_title: "Daglegar aðgerðaáætlanir", h2_desc: "Á hverjum degi færðu persónulegt safn aðgerða þvert á hreyfingu, næringu, svefn og andlega líðan.",
  h3_title: "Fylgstu með og aðlagaðu", h3_desc: "Skráðu virknina þína, fylgstu með framförum og sjáðu heilsueinkunnina batna með tímanum. Appið aðlagast vegferðinni þinni.",
  h4_title: "Regluleg endurmöt", h4_desc: "Skipuleggðu reglulegt endurmat til að mæla raunverulegar líkamlegar breytingar og uppfæra áætlunina þína.",

  pricing_title: "Þjálfunaráskriftir",
  pricing_subtitle: "Veldu áætlunina sem hentar markmiðum þínum",
  pricing_popular_badge: "Vinsælast",
  pricing_cta: "Byrjaðu",
  pricing_free_label: "Ókeypis",
  pricing_soon_label: "Verð væntanlegt",
  plan1_name: "Ókeypis áætlun", plan1_desc: "Prófaðu Lifeline án skuldbindingar",
  plan1_features: ["Grunn heilsuspurningalisti", "Sýnishorn af aðgerðaáætlunum", "Takmörkuð æfingakerfi", "Aðgangur að samfélagi", "Aðgangur að appi"].join("\n"),
  plan2_name: "Sjálfstýrt", plan2_desc: "Öll verkfæri fyrir sjálfstýrða heilsu",
  plan2_features: ["Daglegar aðgerðaáætlanir", "Fullt æfingasafn", "Næringarráðgjöf", "Eftirfylgni með svefni", "Eftirfylgni með framförum", "Aðgangur að samfélagi"].join("\n"),
  plan3_name: "Premium", plan3_desc: "Persónulegur þjálfari innifalinn",
  plan3_features: ["Allt í Sjálfstýrt", "Persónulegur þjálfari", "Vikuleg innskráning", "Sérsniðnar máltíðaáætlanir", "Forgangsþjónusta", "Ítarleg greining"].join("\n"),

  compare_title: "Bera saman áætlanir",
  compare_subtitle: "Sjáðu hvað hvert stig inniheldur",
  compare_h_feature: "Eiginleiki",
  compare_h_free: "Ókeypis",
  compare_h_self: "Sjálfstýrt",
  compare_h_premium: "Premium",
  compare_best: "Best",

  download_title: "Sæktu Lifeline appið",
  download_desc: "Fáanlegt fyrir iOS og Android. Byrjaðu með ókeypis áætluninni og upplifðu persónulega heilsuþjálfun knúna af heilsumatsgögnunum þínum.",

  al_title: "Betri þjálfun byrjar á betri gögnum",
  al_desc: "Niðurstöður heilsumatsins þíns knýja hverja ráðleggingu í appinu. Farðu fyrst í heilsumat fyrir bestu þjálfunarupplifunina.",
  al_cta: "Skoða heilsumatspakka",
};
